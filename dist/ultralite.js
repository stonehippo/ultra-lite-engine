...
var _skill = _interopRequireDefault(require("./skill.js"));
...
exports["default"] = void 0;
var combat = {
  attack: function attack(attacker, target, modifiers) {// determine if the attacker hits the target
...
var skill = {
  ...
  createWithString: function createWithString() {
    var skill = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "Default";
