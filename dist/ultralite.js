...
var util = {
  objectMap: function objectMap(that, spec) {
    ...
    keys.forEach(function (element, _index) {
...
var character = {
  create: function create(spec) {
    ...
    var that = {
      ...
      setAttribute: function setAttribute(attribute, value) {
        ...
        }).length != 0 && Object.prototype.hasOwnProperty.call(_attributeLevels["default"][attribute], value)) {
  ...
  loadCharactersFromLocalFile: function loadCharactersFromLocalFile(filePath) {
    var characterFile = (0, _nodeFs.readFileSync)(filePath, "utf8");
    var characters = JSON.parse(characterFile);
